...
class RealtorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create realtor" do
    assert_difference('Realtor.count') do
      post realtors_url, params: { realtor: { companyid: @realtor.companyid, email: @realtor.email, name: @realtor.name, password: @realtor.password } }
    end
  ...
  test "should update realtor" do
    patch realtor_url(@realtor), params: { realtor: { companyid: @realtor.companyid, email: @realtor.email, name: @realtor.name, password: @realtor.password } }
