...
class HousehuntersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create househunter" do
    assert_difference('Househunter.count') do
      post househunters_url, params: { househunter: { contactmethod: @househunter.contactmethod, email: @househunter.email, name: @househunter.name, password: @househunter.password, phone: @househunter.phone } }
    end
  ...
  test "should update househunter" do
    patch househunter_url(@househunter), params: { househunter: { contactmethod: @househunter.contactmethod, email: @househunter.email, name: @househunter.name, password: @househunter.password, phone: @househunter.phone } }
